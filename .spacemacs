...
;;            gtags-enable-by-default t)
     ...
     (html :variables
           ...
           vscode-css-languageserver-bin t
           vscode-html-languageserver-bin t
...
before packages are loaded."
  ...
  ; control sequences can be used when keyboard mapping is changed outside of Emacs.
  ; For this to work correctly, .emacs must be encoded in the default coding system.
  (mapcar*
   (lambda (r e) ; R and E are matching Russian and English keysyms
     ...
     ; finally, if Russian key maps nowhere, remap it to the English key without any modifiers
  ...
  (add-to-list 'load-path "/home/serg/.emacs.d/elpa/28.1/develop/flex/")
  (require 'flex)
...
;; Do not write anything past this comment. This is whre Emacs will
